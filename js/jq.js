...
function buttonDeatil(href, permission, pers){
	if(permission != ""){
		if ($.inArray(permission, pers) < 0) {
			return "";
		}
	...
	var btn = $("<button class='layui-btn layui-btn-xs' title='查看订单' onclick='window.location=\"" + href +"\"'><i class='layui-icon'>&#xe715;</i></button>");
	return btn.prop("outerHTML");
}
